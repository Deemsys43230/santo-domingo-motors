...
export function VehiclesSection() {
  ...
  const list = useMemo(
    () => (tab === "all" ? vehicles : vehicles.filter((v) => v.category === tab)).slice(0, 6),
    [tab],
  );
                ...
                <div className="p-5 sm:p-6">
                  ...
                  <div className="mt-4 flex flex-wrap items-center justify-between gap-4">
                    ...
                    <div className="flex gap-2 w-full xl:w-auto">
                      <a
                        href="#featured"
                        className="group/btn flex-1 xl:flex-none justify-center inline-flex items-center gap-1.5 bg-[#FFC72C] px-3 py-2 text-[10px] font-bold uppercase tracking-wider text-[#080808] transition-all hover:bg-[#080808] hover:text-white"
                      >
                        {t.vehicles.details}
                      ...
                      <button
                        ...
                        className="eyebrow flex-1 xl:flex-none justify-center border border-[#e8e8e8] px-3 py-2 text-[10px] text-[#080808] transition-all hover:border-[#080808]"
                      >
